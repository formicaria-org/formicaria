...
| **Collaboration (git sync)** | ✅ | per-vault git, `.md` merge driver, pull/push/squash, proposals (create/review/accept/reject), cross-user | `decisions.md#git` · `decisions.md#sync` · `sessions/2026-07-24-proposals-on-the-phone.md` |
| **Mobile / Android** | ✅ | one shared Rust core on the phone, git-coordinated via libgit2 (`native-git`); jniLibs + foreground service | `mobile-design.md` · `decisions.md#track-m` |
