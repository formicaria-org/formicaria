<!-- GENERATED from docs/src/user/setup-linux.md by ci/docs.sh — do not edit. Edit that file instead. -->
<!-- The committed copy is one platform's chapter (whichever machine last built the
     manual). Each release archive carries its own. The other two are beside this file:
     setup-linux.md, setup-macos.md, setup-windows.md. -->
